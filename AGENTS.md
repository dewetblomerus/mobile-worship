...
- Use `mix check` command when you are done with all changes and fix any pending issues
...
- **Always** use DaisyUI instead of manually writing your own tailwind-based components.
